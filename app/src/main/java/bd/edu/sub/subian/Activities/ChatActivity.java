...
import bd.edu.sub.subian.databinding.ActivityChatBinding;
import bd.edu.sub.subian.fragments.ProfileFragment;
        ...
        binding.sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(binding.messageBox.getText().toString())){
                    ...
                    Toast.makeText(ChatActivity.this, "Please enter text here...", Toast.LENGTH_SHORT).show();
                }
                else {
