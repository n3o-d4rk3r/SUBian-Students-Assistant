...
import bd.edu.sub.subian.Activities.ChatFragActivity;
import bd.edu.sub.subian.Models.Status;
import bd.edu.sub.subian.Models.UserStatus;
import bd.edu.sub.subian.R;
import bd.edu.sub.subian.databinding.ItemStatusBinding;
    ...
    public void onBindViewHolder(@NonNull TopStatusViewHolder holder, int position) {
        ...
        holder.binding.circularStatusView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new StoryView.Builder(((ChatFragActivity)context).getSupportFragmentManager())
