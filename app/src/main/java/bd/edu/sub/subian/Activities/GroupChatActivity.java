...
import bd.edu.sub.subian.Adapters.GroupMessagesAdapter;
...
public class GroupChatActivity extends AppCompatActivity {
    ...
    bd.edu.sub.subian.databinding.ActivityGroupChatBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = bd.edu.sub.subian.databinding.ActivityGroupChatBinding.inflate(getLayoutInflater());
