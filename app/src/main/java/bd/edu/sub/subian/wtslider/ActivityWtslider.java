...
import bd.edu.sub.subian.Adapters.PrefManager;
...
*
*/
public class ActivityWtslider extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wtslider);
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(ActivityWtslider.this, PhoneNumberActivity.class));
        finish();
    }
